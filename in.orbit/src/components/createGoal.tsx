...
export default function CreateGoal(){
    ...
    const { register, control, handleSubmit, formState, reset } = useForm<z.infer<typeof createGoalSchema>>({
        resolver:zodResolver(createGoalSchema)
    })

    async function handleCreateGoal(data:z.infer<typeof createGoalSchema>){
        await createGoal({
            title: data.title,
                    ...
                    <form onSubmit={handleSubmit(handleCreateGoal)} className="flex-1 flex flex-col justify-between">
                        <div className="flex flex-col gap-6">
                            <div className="flex flex-col gap-2">
                                ...
                                <Input placeholder="Praticar exercícios, meditar, etc..." autoFocus id="title" {...register('title')}/>
                        ...
                        <div className="flex items-center gap-3">
                            <DialogClose asChild>
                                <Button variant="secondary" className="flex-1" type="button">Fechar</Button>
                            </DialogClose>
